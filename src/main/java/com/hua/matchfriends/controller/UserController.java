...
import com.hua.matchfriends.model.domain.request.UserLoginRequest;
import com.hua.matchfriends.model.domain.request.UserRegisterRequest;
...
import static com.hua.matchfriends.contant.UserConstant.ADMIN_ROLE;
import static com.hua.matchfriends.contant.UserConstant.USER_LOGIN_STATE;
...
//        List<User> list = userList.stream().map(user -> userService.getSafetyUser(user)).collect(Collectors.toList());
        ...
        String redisKey = String.format("matchFriends:user:recommend:%s", loginUser.getId());
